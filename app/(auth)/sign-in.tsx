...
const styles = StyleSheet.create({
  flex: { flex: 1 },
  container: { flexGrow: 1, paddingHorizontal: Spacing['6'], paddingTop: Spacing['16'], paddingBottom: Spacing['10'] },
  ...
  title: {
    ...
    color: DarkColors.text.primary, marginBottom: Spacing['2'],
  },
  subtitle: {
    fontSize: FontSize.base, color: DarkColors.text.secondary,
    marginBottom: Spacing['8'], lineHeight: FontSize.base * 1.5,
  },
